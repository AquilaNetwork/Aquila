package org.aquila.test.crosschain.bitcoinv3;
...
import org.aquila.crosschain.BitcoinACCTv3;
...
public class BitcoinACCTv3Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = BitcoinACCTv3.buildAquilaAT(tradeAccount.getAddress(), bitcoinPublicKeyHash, redeemAmount, bitcoinAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = BitcoinACCTv3.buildAquilaAT(tradeAddress, bitcoinPublicKeyHash, redeemAmount, bitcoinAmount, tradeTimeout);
