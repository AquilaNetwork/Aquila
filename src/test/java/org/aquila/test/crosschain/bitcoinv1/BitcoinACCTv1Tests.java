...
public class BitcoinACCTv1Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = BitcoinACCTv1.buildAquilaAT(tradeAccount.getAddress(), bitcoinPublicKeyHash, hashOfSecretB, redeemAmount, bitcoinAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = BitcoinACCTv1.buildAquilaAT(tradeAddress, bitcoinPublicKeyHash, hashOfSecretB, redeemAmount, bitcoinAmount, tradeTimeout);
