package org.aquila.test.crosschain.piratechainv3;
...
import org.aquila.crosschain.PirateChainACCTv3;
...
public class PirateChainACCTv3Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = PirateChainACCTv3.buildAquilaAT(tradeAccount.getAddress(), pirateChainPublicKey, redeemAmount, arrrAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = PirateChainACCTv3.buildAquilaAT(tradeAddress, pirateChainPublicKey, redeemAmount, arrrAmount, tradeTimeout);
		...
		Long fee = null;
		String name = "UNCIA-ARRR cross-chain trade";
		String description = String.format("Aquila-PirateChain cross-chain trade");
		String atType = "ACCT";
		String tags = "UNCIA-ARRR ACCT";
