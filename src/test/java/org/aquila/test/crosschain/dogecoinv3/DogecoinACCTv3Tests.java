package org.aquila.test.crosschain.dogecoinv3;
...
import org.aquila.crosschain.DogecoinACCTv3;
...
public class DogecoinACCTv3Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = DogecoinACCTv3.buildAquilaAT(tradeAccount.getAddress(), dogecoinPublicKeyHash, redeemAmount, dogecoinAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = DogecoinACCTv3.buildAquilaAT(tradeAddress, dogecoinPublicKeyHash, redeemAmount, dogecoinAmount, tradeTimeout);
		...
		Long fee = null;
		String name = "UNCIA-DOGE cross-chain trade";
		String description = String.format("Aquila-Dogecoin cross-chain trade");
		String atType = "ACCT";
		String tags = "UNCIA-DOGE ACCT";
