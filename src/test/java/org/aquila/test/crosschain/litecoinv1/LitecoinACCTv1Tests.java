...
public class LitecoinACCTv1Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = LitecoinACCTv1.buildAquilaAT(tradeAccount.getAddress(), litecoinPublicKeyHash, redeemAmount, litecoinAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = LitecoinACCTv1.buildAquilaAT(tradeAddress, litecoinPublicKeyHash, redeemAmount, litecoinAmount, tradeTimeout);
