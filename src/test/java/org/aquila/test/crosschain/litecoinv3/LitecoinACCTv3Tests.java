package org.aquila.test.crosschain.litecoinv3;
...
import org.aquila.crosschain.LitecoinACCTv3;
...
public class LitecoinACCTv3Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = LitecoinACCTv3.buildAquilaAT(tradeAccount.getAddress(), litecoinPublicKeyHash, redeemAmount, litecoinAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = LitecoinACCTv3.buildAquilaAT(tradeAddress, litecoinPublicKeyHash, redeemAmount, litecoinAmount, tradeTimeout);
