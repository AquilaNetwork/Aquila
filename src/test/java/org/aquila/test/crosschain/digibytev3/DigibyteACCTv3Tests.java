package org.aquila.test.crosschain.digibytev3;
...
import org.aquila.crosschain.DigibyteACCTv3;
...
public class DigibyteACCTv3Tests extends Common {
	...
	public void testCompile() {
		...
		byte[] creationBytes = DigibyteACCTv3.buildAquilaAT(tradeAccount.getAddress(), digibytePublicKeyHash, redeemAmount, digibyteAmount, tradeTimeout);
	...
	private DeployAtTransaction doDeploy(Repository repository, PrivateKeyAccount deployer, String tradeAddress) throws DataException {
		byte[] creationBytes = DigibyteACCTv3.buildAquilaAT(tradeAddress, digibytePublicKeyHash, redeemAmount, digibyteAmount, tradeTimeout);
		...
		Long fee = null;
		String name = "UNCIA-DGB cross-chain trade";
		String description = String.format("Aquila-Digibyte cross-chain trade");
		String atType = "ACCT";
		String tags = "UNCIA-DGB ACCT";
