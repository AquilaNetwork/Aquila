...
public class SchnorrTests extends Aquila25519Extras {
    ...
    public void testConversion() {
        ...
        PointAccum pointAccum = Aquila25519Extras.newPointAccum();
    ...
    public void testAddition() {
        ...
        PointAccum p1 = Aquila25519Extras.newPointAccum();
        scalarMultBase(s1, p1);

        PointAccum p2 = Aquila25519Extras.newPointAccum();
