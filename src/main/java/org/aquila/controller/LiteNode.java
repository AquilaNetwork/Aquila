...
import static org.aquila.network.message.MessageType.*;
...
public class LiteNode {
    ...
    /**
     * Fetch account data from peers for given UNCIA address
     * @param address - the UNCIA address to query
    ...
    /**
     * Fetch account balance data from peers for given UNCIA address and asset ID
     * @param address - the UNCIA address to query
    ...
    /**
     * Fetch list of transactions for given UNCIA address
     * @param address - the UNCIA address to query
    ...
    /**
     * Fetch list of names for given UNCIA address
     * @param address - the UNCIA address to query
