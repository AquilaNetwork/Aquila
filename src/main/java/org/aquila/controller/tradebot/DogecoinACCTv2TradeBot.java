...
public class DogecoinACCTv2TradeBot implements AcctTradeBot {
	...
	public byte[] createTrade(Repository repository, TradeBotCreateRequest tradeBotCreateRequest) throws DataException {
		...
		byte[] creationBytes = DogecoinACCTv2.buildAquilaAT(tradeNativeAddress, tradeForeignPublicKeyHash, tradeBotCreateRequest.unciaAmount,
	...
	private void handleAliceWaitingForAtLock(Repository repository, TradeBotData tradeBotData,
		...
		byte[] messageData = DogecoinACCTv2.buildRedeemMessage(secretA, aquilaReceivingAddress);
		String messageRecipient = tradeBotData.getAtAddress();
