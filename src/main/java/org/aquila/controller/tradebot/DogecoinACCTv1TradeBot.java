...
public class DogecoinACCTv1TradeBot implements AcctTradeBot {
	...
	/**
	 * Creates a new trade-bot entry from the "Bob" viewpoint, i.e. OFFERing UNCIA in exchange for DOGE.
	 * <p>
	 * Generates:
	 * <ul>
	...
	public byte[] createTrade(Repository repository, TradeBotCreateRequest tradeBotCreateRequest) throws DataException {
		...
		String name = "UNCIA/DOGE ACCT";
		String description = "UNCIA/DOGE cross-chain trade";
		String aTType = "ACCT";
		String tags = "ACCT UNCIA DOGE";
		byte[] creationBytes = DogecoinACCTv1.buildAquilaAT(tradeNativeAddress, tradeForeignPublicKeyHash, tradeBotCreateRequest.unciaAmount,
	...
	private void handleAliceWaitingForAtLock(Repository repository, TradeBotData tradeBotData,
		...
		byte[] messageData = DogecoinACCTv1.buildRedeemMessage(secretA, aquilaReceivingAddress);
		String messageRecipient = tradeBotData.getAtAddress();
	...
	private void handleBobWaitingForAtRedeem(Repository repository, TradeBotData tradeBotData,
		...
		if (crossChainTradeData.mode == AcctMode.REFUNDED || crossChainTradeData.mode == AcctMode.CANCELLED) {
			// Alice hasn't redeemed the UNCIA, so there is no point in trying to redeem the DOGE
			TradeBot.updateTradeBotState(repository, tradeBotData, State.BOB_REFUNDED,
