...
import org.aquila.ApplyUpdate;
import org.aquila.api.ApiRequest;
...
public class AutoUpdate extends Thread {
	...
	public static final String JAR_FILENAME = "aquila.jar";
	public static final String NEW_JAR_FILENAME = "new-" + JAR_FILENAME;
	public static final String AGENTLIB_JVM_HOLDER_ARG = "-DAQUILA_agentlib=";
