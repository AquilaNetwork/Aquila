...
public class PaymentTransaction extends Transaction {
	...
	private PaymentData getPaymentData() {
		if (this.paymentData == null)
			this.paymentData = new PaymentData(this.paymentTransactionData.getRecipient(), Asset.UNCIA, this.paymentTransactionData.getAmount());
	...
	public void orphan() throws DataException {
		// Wrap and delegate payment processing to Payment class. Only revert recipient's last reference if transferring UNCIA.
