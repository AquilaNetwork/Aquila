...
import org.aquila.payment.Payment;
...
public class TransferAssetTransaction extends Transaction {
	...
	public void processReferencesAndFees() throws DataException {
		// Wrap asset transfer as a payment and delegate processing to Payment class. Only update recipient's last reference if transferring UNCIA.
	...
	public void orphanReferencesAndFees() throws DataException {
		// Wrap asset transfer as a payment and delegate processing to Payment class. Only revert recipient's last reference if transferring UNCIA.
