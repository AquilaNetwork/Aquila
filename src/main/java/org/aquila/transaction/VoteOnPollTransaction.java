...
import org.aquila.repository.VotingRepository;
import org.aquila.utils.Unicode;
import org.aquila.voting.Poll;
...
public class VoteOnPollTransaction extends Transaction {
	...
	public ValidationResult isValid() throws DataException {
		...
		if (voter.getConfirmedBalance(Asset.UNCIA) < this.voteOnPollTransactionData.getFee())
