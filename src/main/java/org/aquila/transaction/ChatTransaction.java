...
public class ChatTransaction extends Transaction {
	...
	public static final int POW_DIFFICULTY_ABOVE_UNCIA_THRESHOLD = 8; // leading zero bits
	public static final int POW_DIFFICULTY_BELOW_UNCIA_THRESHOLD = 18; // leading zero bits
	public static final long POW_UNCIA_THRESHOLD = 400000000L;
	...
	public void computeNonce() throws DataException {
		...
		int difficulty = this.getSender().getConfirmedBalance(Asset.UNCIA) >= POW_UNCIA_THRESHOLD ? POW_DIFFICULTY_ABOVE_UNCIA_THRESHOLD : POW_DIFFICULTY_BELOW_UNCIA_THRESHOLD;
	...
	public boolean isSignatureValid() {
		...
		int difficulty;
		try {
			difficulty = this.getSender().getConfirmedBalance(Asset.UNCIA) >= POW_UNCIA_THRESHOLD ? POW_DIFFICULTY_ABOVE_UNCIA_THRESHOLD : POW_DIFFICULTY_BELOW_UNCIA_THRESHOLD;
