...
public class Name {
	...
	public void buy(BuyNameTransactionData buyNameTransactionData, boolean modifyBalances) throws DataException {
		...
		if (modifyBalances) {
			...
			seller.modifyAssetBalance(Asset.UNCIA, buyNameTransactionData.getAmount());
		}
		...
		if (modifyBalances) {
			...
			buyer.modifyAssetBalance(Asset.UNCIA, -buyNameTransactionData.getAmount());
		}
