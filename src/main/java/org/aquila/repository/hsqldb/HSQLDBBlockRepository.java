...
import org.aquila.api.model.BlockSignerSummary;
...
import org.aquila.data.block.BlockArchiveData;
import org.aquila.data.transaction.TransactionData;
import org.aquila.repository.BlockRepository;
...
public class HSQLDBBlockRepository implements BlockRepository {
	...
	public List<BlockSummaryData> getBlockSummariesBySigner(byte[] signerPublicKey, Integer limit, Integer offset, Boolean reverse) throws DataException {
		...
		sql.append("(SELECT * FROM (VALUES (CAST(? AS AquilaPublicKey))) UNION (SELECT reward_share_public_key FROM RewardShares WHERE minter_public_key = ?)) AS PublicKeys (public_key) ");
