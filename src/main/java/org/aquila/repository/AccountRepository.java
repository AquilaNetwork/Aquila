...
public interface AccountRepository {
	...
	/* Returns account's sponsor's public key */
	 ...
	 * <p>
	 * For block processing, accounts that have already received their final UNCIA reward for owning
	 * legacy QORA are omitted from the results. <tt>blockHeight</tt> should be <tt>null</tt>.
	 * <p>
	 * For block orphaning, accounts that did not receive a UNCIA reward at <tt>blockHeight</tt>
	 * are omitted from the results.
	 * 
	 * @param blockHeight UNCIA reward must have be present at this height (for orphaning only)
	 * @throws DataException
	 */
