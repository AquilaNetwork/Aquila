...
import org.aquila.controller.arbitrary.ArbitraryDataFileListManager;
...
import org.aquila.network.task.*;
...
import org.aquila.utils.ExecuteProduceConsume;
import org.aquila.utils.ExecuteProduceConsume.StatsSnapshot;
...
public class Network {
    ...
    private static final String[] INITIAL_PEERS = new String[]{
            ...
            "node.aquila.ru", "node2.aquila.ru", "node3.aquila.ru", "node.aquila.uk", "node22.aquila.org",
            "cinfu1.crowetic.com", "node.cwd.systems", "bootstrap.cwd.systems", "node1.aquilanodes.live",
            "node2.aquilanodes.live", "node3.aquilanodes.live", "node4.aquilanodes.live", "node5.aquilanodes.live",
            "node6.aquilanodes.live", "node7.aquilanodes.live", "node8.aquilanodes.live"
    };
    ...
    public Message buildPeersMessage(Peer peer) {
        ...
        for (PeerData peerData : knownPeers) {
            try {
                ...
                // e.g. don't send localhost:9084 to node4.aquila.org
