...
import org.aquila.arbitrary.ArbitraryDataDiff.*;
import org.aquila.arbitrary.metadata.ArbitraryDataMetadataPatch;
import org.aquila.arbitrary.patch.UnifiedDiffPatch;
...
public class ArbitraryDataMerge {
    ...
    private void copyMetadata() throws IOException {
        Path filePath = Paths.get(this.pathAfter.toString(), ".aquila");
        ArbitraryDataMerge.copyPathToBaseDir(filePath, this.mergePath, Paths.get(".aquila"));
    }
