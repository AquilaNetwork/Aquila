 ...
 * <p>
 * <ul>
 * <li>Bob generates Litecoin & Aquila 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Litecoin & Aquila 'trade' keys</li>
	...
	public static byte[] buildAquilaAT(String creatorTradeAddress, byte[] litecoinPublicKeyHash, long unciaAmount, long litecoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(AquilaFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerLitecoinPKHOffset));
