 ...
 * <p>
 * <ul>
 * <li>Bob generates Dogecoin & Aquila 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Dogecoin & Aquila 'trade' keys</li>
	...
	public static byte[] buildAquilaAT(String creatorTradeAddress, byte[] dogecoinPublicKeyHash, long qortAmount, long dogecoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(AquilaFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerDogecoinPKHOffset));
