 ...
 * <p>
 * <ul>
 * <li>Bob generates Bitcoin & Aquila 'trade' keys
 * 		<ul>
...
public class BitcoinACCTv3 implements ACCT {
	 ...
	 */
	public static byte[] buildAquilaAT(String creatorTradeAddress, byte[] bitcoinPublicKeyHash, long unciaAmount, long bitcoinAmount, int tradeTimeout) {
