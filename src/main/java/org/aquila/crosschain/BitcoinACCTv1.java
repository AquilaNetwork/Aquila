 ...
 * <p>
 * <ul>
 * <li>Bob generates Bitcoin & Aquila 'trade' keys, and secret-b
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Bitcoin & Aquila 'trade' keys</li>
...
public class BitcoinACCTv1 implements ACCT {
	...
	public static final int TRADE_MESSAGE_LENGTH = 32 /*partner's Aquila trade address (padded from 25 to 32)*/
			...
			+ 8 /*lockTimeA*/;
	public static final int REDEEM_MESSAGE_LENGTH = 32 /*secret*/ + 32 /*secret*/ + 32 /*partner's Aquila receiving address padded from 25 to 32*/;
	...
	public static byte[] buildAquilaAT(String creatorTradeAddress, byte[] bitcoinPublicKeyHash, byte[] hashOfSecretB, long unciaAmount, long bitcoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(AquilaFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerBitcoinPKHOffset));
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(AquilaFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrRedeemMessageSecretBOffset));
				// Save B register into data segment starting at addrMessageData (as pointed to by addrMessageDataPointer)
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(FunctionCode.GET_B_IND, addrMessageDataPointer));
	...
	public static byte[] buildTradeMessage(String partnerAquilaTradeAddress, byte[] partnerBitcoinPKH, byte[] hashOfSecretA, int lockTimeA, int lockTimeB) {
	...
	public static byte[] buildRedeemMessage(byte[] secretA, byte[] secretB, String aquilaReceivingAddress) {
		...
		System.arraycopy(aquilaReceivingAddressBytes, 0, data, 64, aquilaReceivingAddressBytes.length);
