		...
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("electrum.aquila.link", Server.ConnectionType.SSL, 56002),
						new Server("electrum-rvn.aquila.online", ConnectionType.SSL, 50002),
						new Server("electrum1-rvn.aquila.online", ConnectionType.SSL, 50002),
