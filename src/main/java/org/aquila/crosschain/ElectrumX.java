...
import org.aquila.crypto.TrustlessSSLSocketFactory;
...
public class ElectrumX extends BitcoinyBlockchainProvider {
	...
	private static final String CLIENT_NAME = "Aquila";
	...
	public BitcoinyTransaction getTransaction(String txHash) throws ForeignBlockchainException {
		...
		try {
			...
			for (Object outputObj : (JSONArray) outputsObj) {
				...
				// For the purposes of Aquila we require all outputs to contain addresses
