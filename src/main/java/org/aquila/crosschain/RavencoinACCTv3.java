 ...
 * <p>
 * <ul>
 * <li>Bob generates Ravencoin & Aquila 'trade' keys
 * 		<ul>
 ...
 * 		<ul>
 * 			<li>Alice generates Ravencoin & Aquila 'trade' keys</li>
...
public class RavencoinACCTv3 implements ACCT {
	 ...
	 */
	public static byte[] buildAquilaAT(String creatorTradeAddress, byte[] ravencoinPublicKeyHash, long unciaAmount, long ravencoinAmount, int tradeTimeout) {
		...
		for (int pass = 0; pass < 2; ++pass) {
			...
			try {
				...
				codeByteBuffer.put(OpCode.EXT_FUN_DAT.compile(AquilaFunctionCode.PUT_PARTIAL_MESSAGE_FROM_TX_IN_A_INTO_B.value, addrTradeMessagePartnerRavencoinPKHOffset));
				...
				throw new IllegalStateException("Unable to compile RVN-UNCIA ACCT?", e);
			}
		}
	...
	public static byte[] buildTradeMessage(String partnerAquilaTradeAddress, byte[] partnerBitcoinPKH, byte[] hashOfSecretA, int lockTimeA, int refundTimeout) {
