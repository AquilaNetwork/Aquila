...
import org.aquila.controller.PirateChainWalletController;
import org.aquila.crosschain.PirateLightClient.Server;
import org.aquila.crosschain.PirateLightClient.Server.ConnectionType;
		...
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("wallet-arrr1.aquila.online", ConnectionType.SSL, 443),
						new Server("wallet-arrr2.aquila.online", ConnectionType.SSL, 443),
						new Server("wallet-arrr3.aquila.online", ConnectionType.SSL, 443),
