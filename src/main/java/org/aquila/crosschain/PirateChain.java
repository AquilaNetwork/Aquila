		...
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("arrrlightd.aquila.online", ConnectionType.SSL, 443),
						new Server("arrrlightd1.aquila.online", ConnectionType.SSL, 443),
						new Server("arrrlightd2.aquila.online", ConnectionType.SSL, 443),
