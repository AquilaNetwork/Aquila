...
import org.aquila.crosschain.ElectrumX.Server;
import org.aquila.crosschain.ElectrumX.Server.ConnectionType;
		...
		MAIN {
			...
			public Collection<ElectrumX.Server> getServers() {
				return Arrays.asList(
						...
						new Server("electrum.aquila.link", Server.ConnectionType.SSL, 50002),
						new Server("electrum.ltc.xurious.com", Server.ConnectionType.SSL, 50002),
						new Server("electrum-ltc.petrkr.net", Server.ConnectionType.SSL, 60002),
						new Server("electrum-ltc.aquila.online", Server.ConnectionType.SSL, 50002),
						new Server("electrum1-ltc.aquila.online", Server.ConnectionType.SSL, 50002),
