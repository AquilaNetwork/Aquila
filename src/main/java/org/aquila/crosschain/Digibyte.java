		...
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("electrum.aquila.link", Server.ConnectionType.SSL, 55002),
						new Server("electrum-dgb.aquila.online", ConnectionType.SSL, 50002),
						new Server("electrum1-dgb.aquila.online", ConnectionType.SSL, 50002),
