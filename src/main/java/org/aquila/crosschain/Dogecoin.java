		...
		MAIN {
			...
			public Collection<Server> getServers() {
				return Arrays.asList(
						...
						new Server("electrum.aquila.link", Server.ConnectionType.SSL, 54002),
						new Server("electrum-doge.aquila.online", ConnectionType.SSL, 50002),
						new Server("electrum1-doge.aquila.online", ConnectionType.SSL, 50002),
