...
public abstract class Crypto {
	...
	public static final byte ADDRESS_VERSION = 23; // A
	public static final byte AT_ADDRESS_VERSION = 28; // C
	...
	public static byte[] getSharedSecret(byte[] privateKey, byte[] publicKey) {
		byte[] x25519PrivateKey = Aquila25519Extras.toX25519PrivateKey(privateKey);
		X25519PrivateKeyParameters xPrivateKeyParams = new X25519PrivateKeyParameters(x25519PrivateKey, 0);

		byte[] x25519PublicKey = Aquila25519Extras.toX25519PublicKey(publicKey);
