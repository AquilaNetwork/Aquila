...
import org.aquila.utils.RandomizeList;
import org.aquila.utils.URLViewer;
...
public class SysTray {
	...
	private SysTray() {
		...
		this.trayIcon = new TrayIcon(Gui.loadImage("icons/aquila_ui_tray_synced.png"), "aquila", null);
	...
	private JPopupMenu createJPopupMenu() {
		...
		about.addActionListener(actionEvent -> {
			...
			JOptionPane.showMessageDialog(null,"Aquila Core\n" + Translator.INSTANCE.translate("SysTray", "BUILD_VERSION") + ":\n" + Controller.getInstance().getVersionStringWithoutPrefix(),"Aquila Core",1);
		});
		menu.add(about);
	...
	public void setTrayIcon(int iconid) {
		try {
			if (trayIcon != null) {
				switch (iconid) {
					case 1:
						this.trayIcon.setImage(Gui.loadImage("icons/aquila_ui_tray_syncing_time-alt.png"));
						break;
					case 2:
						this.trayIcon.setImage(Gui.loadImage("icons/aquila_ui_tray_minting.png"));
						break;
					case 3:
						this.trayIcon.setImage(Gui.loadImage("icons/aquila_ui_tray_syncing.png"));
						break;
					case 4:
						this.trayIcon.setImage(Gui.loadImage("icons/aquila_ui_tray_synced.png"));
						break;
				}
			}
		} catch (Exception e) {
