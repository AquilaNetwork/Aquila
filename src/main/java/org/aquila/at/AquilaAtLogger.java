 ...
 */
public final class AquilaAtLogger extends ExtendedLoggerWrapper implements org.ciyam.at.AtLogger {
    private static final long serialVersionUID = 4740841485167L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = AquilaAtLogger.class.getName();
    ...
    private AquilaAtLogger(final Logger logger) {
     ...
     */
    public static AquilaAtLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new AquilaAtLogger(wrapped);
    }
     ...
     */
    public static AquilaAtLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static AquilaAtLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static AquilaAtLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static AquilaAtLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static AquilaAtLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static AquilaAtLogger create(final String name, final MessageFactory messageFactory) {
