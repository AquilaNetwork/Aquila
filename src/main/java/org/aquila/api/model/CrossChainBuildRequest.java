...
public class CrossChainBuildRequest {
	...
	@Schema(description = "Final UPP amount paid out on successful trade", example = "80.40200000")
	@XmlJavaTypeAdapter(value = org.aquila.api.AmountTypeAdapter.class)
	public long unciaAmount;

	@Schema(description = "UPP amount funding AT, including covering AT execution fees", example = "123.45670000")
	@XmlJavaTypeAdapter(value = org.aquila.api.AmountTypeAdapter.class)
