...
# No aquila.jar but we have a Maven built one?
# Be helpful and copy across to correct location
if [ ! -e aquila.jar -a -f target/aquila*.jar ]; then
	echo "Copying Maven-built Aquila JAR to correct pathname"
	cp target/aquila*.jar aquila.jar
fi
